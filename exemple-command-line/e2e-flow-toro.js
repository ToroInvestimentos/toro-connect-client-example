...
(async ()=> {
  ...
  const issuer = await Issuer.discover('https://conta.toroinvestimentos.com.br');
  ...
  const tokenSet = await client.callback(credentials.redirect_uris[0], parsedResponse, {
